...
Monsters = {'rat':              list((50,   12,      7,      10,     1,   50)),
            ...
            'Giant Rat':        list((130,  30,     18,     100,    12,  100)),
            'Armored Goblin':   list((150,  60,     25,     125,    15,  150)),
            'Zombie':           list((250,  80,     10,     150,    17,  250)),
            'Goblin Zombie':    list((400,  85,     20,     200,    20,  400)),
            'Wolf':             list((200,  95,     35,     190,    23,  200)),
            'Undead Wolf':      list((400,  120,     30,     250,    25,  400)),
            'Ghost':            list((500,  150,     45,     225,    30,  500)),
            'Ghoul':            list((425,  160,     50,     300,    35,  425)),
            'Vampire':          list((650,  190,     60,     500,    40,  650)),
            'Cyclops':          list((700,  180,     100,    525,    45,  700)),
            'Mummy':            list((675,  185,     65,     550,    50,  675)),
            'Earth Elemental':  list((800,  170,     120,    700,    55,  800)),
            'Wind Elemental':   list((750,  140,     100,    700,    55,  750)),
            'Fire Elemental':   list((710,  120,    110,    700,    55,  710)),
            'Water Elemental':  list((850,  180,     100,    700,    55,  850)),
